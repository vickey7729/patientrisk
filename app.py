...
import json
import numpy as np
from model2 import PatientRiskModel2
...
if __name__ == '__main__':
    ...
    if not os.path.exists(template_path):
        print(f"Warning: index.html not found at {template_path}")
        print(f"Please create an index.html file in the templates directory: {os.path.join(base_dir, 'templates')}")
